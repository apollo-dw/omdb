...
<head>
	...
	<meta property="og:title" content="<?php echo safe_htmlspecialchars($PageTitle, ENT_QUOTES); ?> | OMDB">
...
<body>
	<div class="topBar">
		...
		<a href="/charts/" class="hideOnMobile">
		...
		<a href="/lists/" class="hideOnMobile">
			<div class="topBarLink">lists</div>
		</a>
		<a href="/friends/" class="hideOnMobile">
			<div class="topBarLink">friends</div>
		</a>
		<a href="/news/" class="hideOnMobile">
			<div class="topBarLink">news</div>
		</a>

		<form class="topBarSearch" onsubmit="return false">
			<input class="topBarSearchBar" type="text" size="30" onfocusin="searchFocus()"
				onkeyup="showResult(this.value)" value="" autocomplete="off" placeholder="Search... (or paste link)">
		...
		<span style="margin-left:auto;display:flex;align-items:center;">
			...
			<div class="topBarDropDown">
				...
				<div class="dropdown-content" style="font-size: 0.75rem;min-width: 3.5rem;text-align:center;">
					<a id="osuLink" href="">
						<div class="ruleset-icon osu"></div>
					</a>
					<a id="taikoLink" href="">
						<div class="ruleset-icon taiko"></div>
					</a>
					<a id="catchLink" href="">
						<div class="ruleset-icon catch"></div>
					</a>
					<a id="maniaLink" href="">
						<div class="ruleset-icon mania"></div>
					</a>
				</div>
			</div>
			<?php
			if ($loggedIn) {
				?>
				<a href="/dashboard/" class="hideOnMobile">
					<div class="topBarLink">dashboard</div>
				</a>
				<a href="/settings/" style="margin:0 1em;"><b><i class="icon-cogs"></i></b></a>
				<a href="/profile/<?php echo $userId; ?>" style="color:white;"><img
						src="https://s.ppy.sh/a/<?php echo $userId; ?>"
						style="height:2rem;vertical-align:middle;">&ZeroWidthSpace;</img></a>
				<a class="topBarUsername" href="/profile/<?php echo $userId; ?>"
					style="color:white;"><b><?php echo $userName; ?></b></a>
				<?php
			} else {
				?>
