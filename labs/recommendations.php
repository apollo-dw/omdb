<?php
    ...
    $weights = $REC_DEFAULTS['weights'];
    $settings = $REC_DEFAULTS['settings'];
    $weightDescriptions = $REC_DEFAULTS['weightDescriptions'];
    $settingDescriptions = $REC_DEFAULTS['settingDescriptions'];
?>
