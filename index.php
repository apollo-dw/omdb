...
<div style="display: flex;">
    <div>
        ...
        <span style="color:grey;">
            ...
            <span title='<?php echo (int)$stats["online_users"]; ?> within the last day, <?php echo (int)$stats["active_raters"]; ?> rated maps within the last day' style='border-bottom:1px dotted var(--main-theme-text-color);'><?php echo (int)$stats["total_users"]; ?> users</span>,
