...
--
-- Table structure for table `oldbeatmaps`
--

DROP TABLE IF EXISTS `oldbeatmaps`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oldbeatmaps` (
  `DateRanked` date NOT NULL,
  `Artist` varchar(80) DEFAULT NULL,
  `BeatmapID` int NOT NULL,
  `SetID` int NOT NULL,
  `CreatorID` int NOT NULL,
  `SR` decimal(9,6) NOT NULL,
  `CS` decimal(7,5) NOT NULL,
  `OD` decimal(4,2) NOT NULL,
  `AR` decimal(7,5) NOT NULL,
  `HP` decimal(4,2) NOT NULL,
  `Source` varchar(76) DEFAULT NULL,
  `Genre` int NOT NULL,
  `Lang` int NOT NULL,
  `Title` varchar(80) DEFAULT NULL,
  `DifficultyName` varchar(80) DEFAULT NULL,
  `Mode` int NOT NULL,
