...
<div class="flex-row-container centered">
    <?php
    while ($row = $similarUsers->fetch_assoc()) {
    ?>
        <div class="flex-container alternating-bg" style="align-items: center;">
            <a href="/profile/<?php echo $row["UserID"]; ?>"><img class="square-thumb" src="https://s.ppy.sh/a/<?php echo $row["UserID"]; ?>" style="height:4em;width:4em;padding:1em;" title="<?php echo safe_htmlspecialchars(GetUserNameFromId($row["UserID"], $conn), ENT_QUOTES); ?>"/></a>
