...
<div id='set' class='tab' style='display:none;'>
    ...
    ?>
        ...
        <br><br>
        <hr>
        <b>Determining who the nominators of a moddingv1 set are is tricky.</b><br>
        You'll need to look at the mapset's forum post and guesstimate, since icons have been removed. You can find the forum post through the modding discussions (BanchoBot will have posted a link to it)
        <hr>
