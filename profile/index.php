...
<style>
    :root {
        <?php foreach ($activeTheme as $variable => $value): ?>--<?= htmlspecialchars($variable, ENT_QUOTES, 'UTF-8'); ?>: <?= htmlspecialchars($value, ENT_QUOTES, 'UTF-8'); ?>;
        <?php endforeach; ?>--top-bar-icon-hue: <?= $imageFilter['rotation'] ?>deg;
